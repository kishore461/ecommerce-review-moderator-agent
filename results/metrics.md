...
| System | TP | FP | TN | FN | Routed | Precision | Recall | F1 | Human review | Total cost | ECE |
|---|---|---|---|---|---|---|---|---|---|---|---|
| baseline_keyword | 11 | 6 | 14 | 9 | 0 | 0.647 | 0.550 | 0.595 | 0.000 | 68.000 | - |
| expected_cost | 13 | 1 | 13 | 2 | 11 | 0.929 | 0.867 | 0.897 | 0.275 | 31.000 | 0.145 |
| fixed_band | 14 | 1 | 15 | 4 | 6 | 0.933 | 0.778 | 0.848 | 0.150 | 42.000 | 0.145 |
...
| System | TP | FP | TN | FN | Routed | Precision | Recall | F1 | Human review | Total cost | ECE |
|---|---|---|---|---|---|---|---|---|---|---|---|
| baseline_keyword | 6 | 3 | 2 | 1 | 0 | 0.667 | 0.857 | 0.750 | 0.000 | 14.500 | - |
| expected_cost | 2 | 0 | 5 | 4 | 1 | 1.000 | 0.333 | 0.500 | 0.083 | 15.000 | 0.210 |
| fixed_band | 2 | 0 | 5 | 4 | 1 | 1.000 | 0.333 | 0.500 | 0.083 | 17.000 | 0.210 |
